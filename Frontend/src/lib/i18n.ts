...
export const zhTranslations: TranslationKeys = {
  ...
  landing: {
    hero: {
      ...
      subtitle: 'AI时代，人人都是独立开发者',
      description: '想独立开发一个AI应用，却无从下手？想快速验证自己的产品想法，形成商业闭环？PRD For AI作为你的产品落地向导，助你快速构建MVP。',
      cta: '立即注册，免费试用',
      features: {
        feature1: '30秒定制产品规划',
        feature2: '可交互式任务列表',
      ...
      // 新增的翻译键值
      webVersion: 'Web版 - 智能产品战略规划',
      chromeExtension: 'Chrome插件 - 一键分析',
      oneClickAnalysis: '一键分析',
      anyWebpageOneClick: '任意网页一键生成竞品分析',
      breakBarriers: '打破传统软件开发壁垒，让每个人都能将需求落地为产品',
      multimodalInput: '支持文字、图片等多模态输入',
      // 产品功能截图部分
      aiMultimodalAnalysis: 'AI 多模态分析 ',
      combineWebpageCode: '结合网页代码、截图和 AI 的多模态分析，结果更准确、更完整',
      customDocumentTemplates: '自定义产品规划模板',
      useYourOwnTemplates: '使用您自己的产品规划模板？将自定义模板添加到您的账户',
      ...
      testimonial1: '我不敢相信 PRD For AI 能做得如此出色。我很震惊。这是一个游戏规则改变者。',
      testimonial2: '我对AI产品规划听起来不够人性化持怀疑态度。PRD For AI 改变了一切。',
      ...
      weMakePRDAffordable: 'PRD For AI，让每个人都能轻松将想法转化为产品。',
      whyChoosePRD: '为什么选择 PRD For AI？',
      aiWorksForYou: 'AI 为你和你的团队工作',
      prdCustomizedForYou: 'PRD For AI 针对你的角色、公司和团队进行了定制，因此你可以在几分钟内获得高质量的产品规划。',
      productFeatureScreenshots: '产品功能截图',
      registerNow: '立即注册',
    },
    features: {
      title: '两周AI冲刺，快速验证产品想法',
      subtitle: 'AI产品经理助手',
      description: '告别繁琐的文档工作，只需用自然语言描述你的产品想法，PRD For AI 协助你快速构建MVP，让你专注于AI产品战略素养的提升。',
      list: {
        multimodal: {
          title: '支持多模态输入',
    ...
    testimonials: {
      title: '用户都在说什么',
      subtitle: '数千位产品经理、独立开发者、设计师的真实反馈',
      reviews: {
        review1: {
          content: '用了 PRD For AI，我的工作更专注于产品战略的思考，而不是反复修改产品文档。特别是Chrome插件功能，分析竞品网站太方便了。',
          author: '李明',
          role: 'AI产品经理',
        },
        review2: {
          content: '这简直是独立开发者的秘密武器！AI生成的产品规划结构清晰，并且有战略性指导，太实用了。',
          author: '王晓',
          role: '创业者',
        },
        review3: {
          content: '作为设计师，我用它来快速理解产品需求。特别喜欢多模态输入，上传个截图就能生成对应的产品规划。',
          author: '张伟',
          role: '设计师',
        },
      },
    ...
    howItWorks: {
      ...
      steps: {
        ...
        step2: {
          title: 'AI 智能分析生成',
          description: '基于您的输入，AI 自动生成结构化的产品规划，包含产品核心定位、AI引擎搭建、前后端及数据库构建、数据流设计、MVP上线行动清单等完整内容',
          tags: ['核心定位', 'AI引擎搭建', '技术栈选型', '数据流设计', 'MVP上线行动清单'],
        },
        step3: {
          title: '编辑与导出分享',
          description: '在可视化画布中编辑产品规划，支持实时预览，完成后可导出为多种格式分享给团队，提升协作效率',
    ...
    cta: {
      title: '开始您的智能创作之旅',
      description: '加入数千位产品经理、独立开发者的选择，让 AI 助力您的产品发布上线。Chrome插件 + Web版双重体验，想法落地从未如此简单。',
      button: '立即注册，免费试用',
    ...
    footer: {
      ...
      copyright: '© 2024 PRD For AI · 创意触手可及。',
    },
  },
  auth: {
    login: {
